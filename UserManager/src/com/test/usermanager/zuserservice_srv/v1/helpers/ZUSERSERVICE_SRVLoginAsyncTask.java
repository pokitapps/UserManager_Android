 ...
 */
public class ZUSERSERVICE_SRVLoginAsyncTask extends AsyncTask<Void, Void, Boolean> 
{
	...
	private static final String TAG = "ZUSERSERVICE_SRVLoginAsyncTask";
	 ...
	 */
	public ZUSERSERVICE_SRVLoginAsyncTask(ILoginAsyncTask activity, Context context, String userName, String password, String vaultPassword, String vaultSalt) 
	{
	...
	protected Boolean doInBackground(Void... arg0) 
	{
		...
		try
        {
			result = ZUSERSERVICE_SRVRequestHandler.getInstance(context).executeLoginUsernamePassword(userName, password, vaultPassword, vaultSalt);
        } 
